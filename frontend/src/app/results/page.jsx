...
function SearchResult() {
    ...
    return (
        <div>
            ...
            <div className="tab-contents w-full min-h-[400px] px-4 md:px-8 2xl:px-52">
                ...
                <div className="flex flex-wrap gap-4 justify-start">
                    {loading ? (
                        ...
                        filteredItems.map((item) => (
                            <Link
                            key={item.id} // Use a unique key based on your item's unique property
                            href={`/item/${item.id}`} // Replace with actual item URL
